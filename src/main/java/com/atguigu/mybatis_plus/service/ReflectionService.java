...
public class ReflectionService {
     ...
     * @throws Exception
     */
    public void invokeService(String classz, String methodName, Object param) throws Exception {
        if (!applicationContext.containsBean(classz)) {
            throw new RuntimeException("Spring找不到对应的Bean");
        }
        ...
        /* 用spring容器中bean代理类对象执行和目标类对象执行方法都可以 */
        // 代理类对象执行方法
        //method.invoke(proxyObject, param);
        // 目标类对象执行方法
        targetMethod.invoke(proxyObject, param);
    }
